...
# Generated by qmake (3.0) (Qt 5.0.2) on: Sat May 11 22:41:32 2013
# Project:  Alcantara.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile Alcantara.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_DBUS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++-64 -I. -I. -Iinclude -I/usr/include/qt -I/usr/include/qt/QtDBus -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lQt5DBus -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: Alcantara.pro /usr/lib/qt/mkspecs/linux-g++-64/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/1.0.0/ && $(COPY_FILE) --parents include/Alcantara.h include/singleInstance.h .tmp/1.0.0/ && $(COPY_FILE) --parents main.cpp src/Alcantara.cpp src/singleInstance.cpp .tmp/1.0.0/ && (cd `dirname .tmp/1.0.0` && $(TAR) 1.0.0.tar 1.0.0 && $(COMPRESS) 1.0.0.tar) && $(MOVE) `dirname .tmp/1.0.0`/1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/1.0.0
...
moc_Alcantara.cpp: /usr/include/qt/QtCore/QProcess \
		...
		/usr/include/qt/QtCore/QListIterator \
		ui_alcantara.h \
		/usr/include/qt/QtCore/QVariant \
		include/Alcantara.h
	/usr/lib/qt/bin/moc $(DEFINES) $(INCPATH) include/Alcantara.h -o moc_Alcantara.cpp

moc_singleInstance.cpp: /usr/include/qt/QtCore/QObject \
		/usr/include/qt/QtCore/qobject.h \
		/usr/include/qt/QtCore/qobjectdefs.h \
		/usr/include/qt/QtCore/qnamespace.h \
		/usr/include/qt/QtCore/qglobal.h \
	...
	/usr/lib/qt/bin/moc $(DEFINES) $(INCPATH) include/singleInstance.h -o moc_singleInstance.cpp
